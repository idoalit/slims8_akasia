    ...
    <ul class="topic d-flex flex-wrap justify-content-center">
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="#" class="d-flex flex-column">
                <img src="<?php echo assets('images/books.png'); ?>" width="80" class="mb-3 mx-auto"/>
                literature
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="#" class="d-flex flex-column">
                <img src="<?php echo assets('images/diploma.png'); ?>" width="80" class="mb-3 mx-auto"/>
                social sciences
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="#" class="d-flex flex-column">
                <img src="<?php echo assets('images/blackboard.png'); ?>" width="80" class="mb-3 mx-auto"/>
                applied sciences
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="#" class="d-flex flex-column">
                <img src="<?php echo assets('images/quill.png'); ?>" width="80" class="mb-3 mx-auto"/>
                art and recreation
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="#" class="d-flex flex-column">
                <img src="<?php echo assets('images/icon/ios7-arrow-thin-right.png'); ?>" width="80"
                     class="mb-3 mx-auto"/>
                see more.
            </a>
        </li>
...
<section class="mt-5 container">
    ...
    <div class="d-flex flex-wrap">
      ...
      foreach ($topics as $topic) {
        echo '<a href="#" class="btn btn-outline-secondary btn-rounded btn-sm mr-2 mb-2">' . $topic . '</a>';
      }
      ?>
    </div>
...
<section class="mt-5 bg-white">
    <div class="container py-5">
        ...
        <div class="card-deck">
          <?php
          $members = getActiveMembers($dbs, 2017);
...
<section class="mt-5 container">
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            ...
            <p>Telp. (021) 9172638<br>Fax. (021) 9172638</p>
            <p class="d-flex flex-row">
                <button type="button" class="btn btn-primary mr-2" name="button"><i class="fab fa-facebook-square"></i>
                </button>
                <button type="button" class="btn btn-info mr-2" name="button"><i class="fab fa-twitter-square"></i>
                </button>
                <button type="button" class="btn btn-danger mr-2" name="button"><i
